...
// 7 . เมื่อ tail = max แล้ว tail ต้อง เท่ากับ 0
test('เมื่อ tail = max แล้ว tail ต้อง เท่ากับ 0', ()=> {
    const queue = new Queue(1)
    queue.enqueue(2)
    queue.dequeue()
    expect(queue.tail()).toBe(0)
})
// 7 . เมื่อ head = max แล้ว head ต้อง เท่ากับ 0
test('เมื่อ head = max แล้ว head ต้อง เท่ากับ 0', ()=> {
    const queue = new Queue(1)
    queue.enqueue(2)
    queue.dequeue()
